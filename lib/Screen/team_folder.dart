...
import 'package:flutter_app_ui_designs/Screen/project.dart';
...
class TeamFolderScreen extends StatefulWidget {
  const TeamFolderScreen({Key? key}) : super(key: key);

  @override
  State<TeamFolderScreen> createState() => _TeamFolderPageSScreen();
}

class _TeamFolderPageSScreen extends State<TeamFolderScreen> {
        ...
        Expanded(
          child: ListView(
            ...
            children: [
              ...
              //* Folder List
              buildProjectRow("Chatbox"),     //* <-- Call buildProjectRow Widget
  ...
  //TODO Create buildProjectRow Widget 
  Widget buildProjectRow(String folderName) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute<void>(
      builder: (BuildContext context) =>  ProjectScreen(folderName: folderName,),));
      },
      child: Container(
   ...
   //TODO Create buildFileColumn Function 
 ...
 //TODO Create buildFileSizeChart Function 
